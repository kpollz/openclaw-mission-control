...
import {
  type getProjectWebhookApiV1ProjectsProjectIdWebhooksWebhookIdGetResponse,
  type listProjectWebhookPayloadsApiV1ProjectsProjectIdWebhooksWebhookIdPayloadsGetResponse,
  useGetProjectWebhookApiV1ProjectsProjectIdWebhooksWebhookIdGet,
  useListProjectWebhookPayloadsApiV1ProjectsProjectIdWebhooksWebhookIdPayloadsGet,
} from "@/api/generated/project-webhooks/project-webhooks";
import type { ProjectWebhookPayloadRead } from "@/api/generated/model";
...
export default function WebhookPayloadsPage() {
  ...
  const webhookQuery = useGetProjectWebhookApiV1ProjectsProjectIdWebhooksWebhookIdGet<
    getProjectWebhookApiV1ProjectsProjectIdWebhooksWebhookIdGetResponse,
    ApiError
  >(projectId ?? "", webhookId ?? "", {
    query: {
      enabled: Boolean(isSignedIn && isAdmin && projectId && webhookId),
  ...
  const payloadsQuery =
    useListProjectWebhookPayloadsApiV1ProjectsProjectIdWebhooksWebhookIdPayloadsGet<
      listProjectWebhookPayloadsApiV1ProjectsProjectIdWebhooksWebhookIdPayloadsGetResponse,
      ApiError
    >(
      projectId ?? "",
      webhookId ?? "",
  ...
  return (
    <DashboardPageLayout
      signedOut={{
        ...
        forceRedirectUrl: `/projects/${projectId}/webhooks/${webhookId}/payloads`,
        signUpForceRedirectUrl: `/projects/${projectId}/webhooks/${webhookId}/payloads`,
      }}
    ...
    >
      <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="space-y-3">
          {payloads.map((payload: ProjectWebhookPayloadRead) => (
            <div
              key={payload.id}
