...
class OrganizationMemberRead(SQLModel):
    ...
    all_projects_write: bool
    created_at: datetime
    updated_at: datetime
    user: OrganizationUserRead | None = None
    project_access: list[OrganizationProjectAccessRead] = Field(default_factory=list)
...
class OrganizationProjectAccessSpec(SQLModel):
...
class OrganizationProjectAccessRead(SQLModel):
...
class OrganizationMemberAccessUpdate(SQLModel):
    ...
    all_projects_write: bool = False
    project_access: list[OrganizationProjectAccessSpec] = Field(default_factory=list)
