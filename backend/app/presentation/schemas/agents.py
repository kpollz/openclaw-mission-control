...
class AgentBase(SQLModel):
    ...
    model_config = SQLModelConfig(
        json_schema_extra={
            ...
            "x-prerequisites": [
                "project_id if required by your board policy",
    ...
    project_id: UUID | None = Field(
        default=None,
        description="Project id that scopes this agent. Omit only when policy allows global agents.",
