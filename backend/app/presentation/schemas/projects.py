"""Schemas for project create/update/read API operations."""
...
_ERR_GOAL_FIELDS_REQUIRED = "Confirmed goal projects require objective and success_metrics"
...
class ProjectBase(SQLModel):
    """Shared project fields used across create and read payloads."""
...
class ProjectCreate(ProjectBase):
    ...
    def validate_goal_fields(self) -> Self:
        """Require gateway and goal details when creating a confirmed goal project."""
...
class ProjectRead(ProjectBase):
    """Project payload returned from read endpoints."""
