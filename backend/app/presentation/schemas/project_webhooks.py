"""Schemas for project webhook configuration and payload capture endpoints."""
...
class ProjectWebhookCreate(SQLModel):
...
class ProjectWebhookUpdate(SQLModel):
    """Payload for updating a project webhook."""
...
class ProjectWebhookRead(SQLModel):
...
class ProjectWebhookPayloadRead(SQLModel):
...
class ProjectWebhookIngestResponse(SQLModel):
