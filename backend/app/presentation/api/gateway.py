...
from app.infrastructure.gateway.rpc_client import GATEWAY_EVENTS, GATEWAY_METHODS, PROTOCOL_VERSION
...
async def list_gateway_sessions(
    ...
    """List sessions for a gateway associated with a project."""
    service = GatewaySessionService(session)
