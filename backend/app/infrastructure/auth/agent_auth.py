...
from app.domain.services.agent_presence import normalize_heartbeat_status
from app.infrastructure.auth.agent_tokens import verify_agent_token
from app.infrastructure.database.engine import get_session
from app.infrastructure.models.agents import Agent
from app.shared.client_ip import get_client_ip
from app.shared.logging import get_logger
from app.shared.rate_limit import agent_auth_limiter
...
async def _touch_agent_presence(
    ...
    agent.status = normalize_heartbeat_status(None, current_status=agent.status)
    session.add(agent)
