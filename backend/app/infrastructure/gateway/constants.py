...
HEARTBEAT_LEAD_TEMPLATE = "PROJECT_HEARTBEAT.md.j2"
HEARTBEAT_AGENT_TEMPLATE = "PROJECT_HEARTBEAT.md.j2"
SESSION_KEY_PARTS_MIN = 2
_SESSION_KEY_PARTS_MIN = SESSION_KEY_PARTS_MIN

MAIN_TEMPLATE_MAP = {
    "AGENTS.md": "PROJECT_AGENTS.md.j2",
    "IDENTITY.md": "PROJECT_IDENTITY.md.j2",
    "SOUL.md": "PROJECT_SOUL.md.j2",
    "MEMORY.md": "PROJECT_MEMORY.md.j2",
    "HEARTBEAT.md": "PROJECT_HEARTBEAT.md.j2",
    "USER.md": "PROJECT_USER.md.j2",
    "TOOLS.md": "PROJECT_TOOLS.md.j2",
}

PROJECT_SHARED_TEMPLATE_MAP = {
    "AGENTS.md": "PROJECT_AGENTS.md.j2",
    "BOOTSTRAP.md": "PROJECT_BOOTSTRAP.md.j2",
    "IDENTITY.md": "PROJECT_IDENTITY.md.j2",
    "SOUL.md": "PROJECT_SOUL.md.j2",
    "MEMORY.md": "PROJECT_MEMORY.md.j2",
    "HEARTBEAT.md": "PROJECT_HEARTBEAT.md.j2",
...
_TOOLS_KV_RE = re.compile(r"^(?:-\s*`)?(?P<key>[A-Z0-9_]+)=(?P<value>.*?)(?:`)?\s*$")
